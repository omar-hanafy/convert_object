...
Utilities BoolParsingX.asBool->bool; NumParsingTextX: toNum/try,toInt/try,toDouble/try,toNumFormatted/try,toIntFormatted/try,toDoubleFormatted/try; DateParsingTextX: toDateTime/try,toDateFormatted/try,toDateAutoFormat/try; TextJsonX.tryDecode/decode; UriParsingX: isValidPhoneNumber,isEmailAddress,toPhoneUri,toMailUri,toUri; jsonSafe(value,{JsonOptions?,toEncodable?}) for arbitrary objects with DateTime/Duration/enum/Uint8List strategies; JsonMapX.toJsonMap()/toJsonString()/encodeWithIndent; JsonIterableX.toJsonList()/toJsonString()/encodeWithIndent; JsonAnyX.toJsonSafe()/toJsonString().
